...
fullBio <- fullBio[,grep("[.](1|2)|Cells|Cytoplasm.*Dapi|Cytoplasm.*Area|CellMask|Center|Nuclei.*KRT|_SE|Euler|Logit|4N", colnames(fullBio), value = TRUE, invert = TRUE), with = FALSE]
...
m <- as.matrix(l4pcvDT[,grep("Ligand|ECMp|MEP|Barcode|4N",x = colnames(l4pcvDT), value = TRUE, invert = TRUE), with = FALSE])
