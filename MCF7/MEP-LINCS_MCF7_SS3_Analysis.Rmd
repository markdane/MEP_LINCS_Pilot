...
fullBio <- fullBio[,grep("[.](1|2)|Cells|Cytoplasm.*Dapi|Cytoplasm.*Area|CellMask|Center|Nuclei.*KRT|_SE|Euler|4N", colnames(fullBio), value = TRUE, invert = TRUE), with = FALSE]
...
PCFVNames <- grep("Euler|MaximumRadius|_SE|_RobustZ|Center|4N",PCFVNames,invert = TRUE, value = TRUE)
